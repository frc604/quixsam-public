...
public class DiffDriveOdometryMeasurement {
    ...
    public DiffDriveOdometryMeasurement(Rotation2d gyroAngle, double leftDistanceMeters, double rightDistanceMeters, double sigmaX, double sigmaY, Rotation2d sigmaTheta) {
